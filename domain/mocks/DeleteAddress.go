...
// DeleteAddressMock is an autogenerated mock type for the DeleteAddressMock type
type DeleteAddressMock struct {
	mock.Mock
}

// Execute provides a mock function with given fields: ctx, userID
func (_m *DeleteAddressMock) Execute(ctx entities.ApplicationContext, userID int64) error {
